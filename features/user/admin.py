...
class UserAdmin(admin.ModelAdmin):
    ...
    def get_initial_fieldsets(self, request: HttpRequest, obj=None):
        if request.GET.get("colaborador"):
            return self.add_colaborador_fieldsets
        if not obj:
