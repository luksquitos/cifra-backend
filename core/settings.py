...
#     "https://labfreq.otimizesolutions.com.br",
#     "https://api.controlm.log.br",
# ]

INSTALLED_APPS = [
    # Widgets
    "widgets.split_date_time",
    "widgets.related_widget_wrapper",
    "widgets.input_mask",
    #Permissions
    "core.permissions",
    # Custom Admin
...
REST_FRAMEWORK = {
    ...
    # "DEFAULT_PERMISSION_CLASSES": ("rest_framework.permissions.IsAuthenticated",), #FIXME Remover posteriormente
